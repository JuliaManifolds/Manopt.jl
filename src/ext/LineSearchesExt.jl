...
Initial step selection is not supported, value 1.0 is always used. Retraction used
for determining the line along which the search is performed can be provided
