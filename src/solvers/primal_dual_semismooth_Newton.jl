...
function PrimalDualManifoldSemismoothNewtonObjective(
    ...
    return PrimalDualManifoldSemismoothNewtonObjective{C, PF, DPF, PG, DPG, LFO, AL, L}(
        cost, prox_F, diff_prox_F, prox_G_dual, diff_prox_G_dual, linearized_forward_operator, adjoint_linearized_operator, Λ,
    )
end
