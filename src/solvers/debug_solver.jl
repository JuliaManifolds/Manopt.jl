"""
    initialize_solver!(p::AbstractManoptProblem, o::DebugOptions)
...
"""
function initialize_solver!(p::AbstractManoptProblem, o::DebugOptions)
...
"""
    step_solver!(p::AbstractManoptProblem, o::DebugOptions, i)
...
"""
function step_solver!(p::AbstractManoptProblem, o::DebugOptions, i)
...
"""
function stop_solver!(p::AbstractManoptProblem, o::DebugOptions, i::Int)
