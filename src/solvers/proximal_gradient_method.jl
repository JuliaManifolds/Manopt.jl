...
Perform the proximal gradient method as introduced in [BergmannJasaJohnPfeffer:2025:1](@cite).
See also [FengHuangSongYingZeng:2021](@cite) and [BergmannJasaJohnPfeffer:2025:2](@cite) for related work.
