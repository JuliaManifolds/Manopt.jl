...
$(_kwargs(:evaluation))
$(_kwargs(:stopping_criterion; default = "[`StopAfterIteration`](@ref)`(`$(_link(:manifold_dimension))$(_sc(:Any))[`StopWhenRelativeResidualLess`](@ref)`(c,1e-8)`,  where `c` is ``$(_tex(:norm, "b"))``"))
$(_note(:OutputSection))
"""
