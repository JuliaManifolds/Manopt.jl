...
like the steepest descent direction in [`gradient_descent`](@ref), it is common to perform a step size computation.
A special case is a line search method; both a step size computation and a line search start from an initial guess.
