...
vector_transport_to!(::Stiefel,Y,p,X,q,::ProjectionTransport) = (Y .= project(M_n_1000_k_3_m_4, q, X))
...
for i in 1:5
    ...
    bench_n_1000_k_3_m_4 = @benchmark quasi_Newton(M_n_1000_k_3_m_4, F_n_1000_k_3_m_4, ∇F_n_1000_k_3_m_4, $x; memory_size = 4, vector_transport_method = ProjectionTransport(), retraction_method = QRRetraction(), stopping_criterion = StopWhenGradientNormLess(norm(M_n_1000_k_3_m_4,$x,∇F_n_1000_k_3_m_4($x))*10^(-6))) seconds = 600 samples = 1 evals = 1
