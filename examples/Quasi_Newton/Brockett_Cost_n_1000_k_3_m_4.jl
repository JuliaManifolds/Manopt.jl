...
function vector_transport_to!(::Stiefel, Y, p, X, q, ::ProjectionTransport)
    return (Y .= project(M_n_1000_k_3_m_4, q, X))
end
...
function ∇F_n_1000_k_3_m_4(X::Array{Float64,2})
    return 2 * A_n_1000_k_3_m_4 * X * N_n_1000_k_3_m_4 -
           X * X' * A_n_1000_k_3_m_4 * X * N_n_1000_k_3_m_4 -
           X * N_n_1000_k_3_m_4 * X' * A_n_1000_k_3_m_4 * X
end
sample_times_n_1000_k_3_m_4 = []

for i in 1:5
    x = random_point(M_n_1000_k_3_m_4)
    bench_n_1000_k_3_m_4 = @benchmark quasi_Newton(
        M_n_1000_k_3_m_4,
        F_n_1000_k_3_m_4,
        ∇F_n_1000_k_3_m_4,
        $x;
        ...
        stopping_criterion=StopWhenGradientNormLess(
            norm(M_n_1000_k_3_m_4, $x, ∇F_n_1000_k_3_m_4($x)) * 10^(-6)
        ),
    ) seconds = 600 samples = 1 evals = 1
    append!(sample_times_n_1000_k_3_m_4, bench_n_1000_k_3_m_4.times)
end

result_n_1000_k_3_m_4 =
    sum(sample_times_n_1000_k_3_m_4) / length(sample_times_n_1000_k_3_m_4) / 1000000000
