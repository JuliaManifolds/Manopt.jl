...
for i in 1:10
    ...
    bench_n_32_k_32_m_2 = @benchmark quasi_Newton(M_n_32_k_32_m_2, F_n_32_k_32_m_2, ∇F_n_32_k_32_m_2, $x; memory_size = 2, vector_transport_method = ProjectionTransport(), stopping_criterion = StopWhenGradientNormLess(norm(M_n_32_k_32_m_2,$x,∇F_n_32_k_32_m_2($x))*10^(-6))) seconds = 600 samples = 10 evals = 1
