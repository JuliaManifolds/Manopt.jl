...
for i in 1:2
    ...
    norm_gradient_stopping = norm(M_n_42_k_42_m_4,x,∇F_n_42_k_42_m_4(x))*10^(-6)
    bench_n_42_k_42_m_4 = @benchmark quasi_Newton(M_n_42_k_42_m_4, F_n_42_k_42_m_4, ∇F_n_42_k_42_m_4, $x; memory_size = 4, vector_transport_method = ProjectionTransport(), stopping_criterion = StopWhenGradientNormLess($norm_gradient_stopping)) seconds = 20 samples = 3
