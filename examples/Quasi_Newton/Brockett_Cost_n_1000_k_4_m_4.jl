...
for i in 1:10
    ...
    bench_n_1000_k_4_m_4 = @benchmark quasi_Newton(M_n_1000_k_4_m_4, F_n_1000_k_4_m_4, ∇F_n_1000_k_4_m_4, $x; memory_size = 4, vector_transport_method = ProjectionTransport(), stopping_criterion = StopWhenGradientNormLess(norm(M_n_1000_k_4_m_4,$x,∇F_n_1000_k_4_m_4($x))*10^(-6))) seconds = 600 samples = 10 evals = 1
