...
special_oracle(M, p) = FW_oracle(M, H, A, p, grad_weighted_mean_cost(M, p))

# ╔═╡ 3d369862-dc1c-4e06-acde-9eb1baa1a425
Frank_Wolfe_algorithm(
    M, weighted_mean_cost, grad_weighted_mean_cost, data[1]; subtask=special_oracle
)
