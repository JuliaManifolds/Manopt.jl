...
We can finally use another way to determine the step size, for example
the default [`ArmijoLinesearch`](@ref) [stepsize](../commons/stepsizes.md) rule, but with more expensive parameter choices.
...
res = cyclic_proximal_point(N, g, proxes_g, data2[1];
  debug=[:Iteration," | ",:Change," | ",(:Cost, "f(p): %1.12f"),"\n", 1000, :Stop,
        ],
