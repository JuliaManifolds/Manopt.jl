...
how to use [`Manopt.jl`](../index.md) to perform optimisation on manifolds in [Julia](https://julialang.org).
...
!!! note "Technical Detail"
    The recording is realised by [`RecordAction`](@ref)s that are (also) executed at every iteration. These can also be individually implemented and added to the `record=` array instead of symbols.
```
