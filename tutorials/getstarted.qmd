...
We can also, for illustration reasons, just look at the first 6 steps by setting a [`stopping_criterion=`](../plans/stopping_criteria.md)
...
a little more expensive [`ArmijoLinesearch`](@ref) than the default [stepsize](../plans/stepsize.md) rule used on the Sphere.
