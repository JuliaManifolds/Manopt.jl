...
then we can use the least squares error to state the objetive function as ``[Fletcher, IJCV, 2013](@cite Fletcher:2013)``{=commonmark}.
...
see for example ``[Bergmann, Gousenbourger, Front. Appl. Math. Stat., 2018](@cite BergmannGousenbourger:2018)``{=commonmark} for details or Equations (7) and (8) of ``[Fletcher, IJCV, 2013](@cite Fletcher:2013)``{=commonmark}:
"""
