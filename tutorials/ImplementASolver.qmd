...
tutorial [Get started: optimize](https://manoptjl.org/stable/tutorials/getstarted.html)
...
We first define our task, the Riemannian Center of Mass from the [Get started: optimize](https://manoptjl.org/stable/tutorials/getstarted.html) tutorial.
