...
We first define our task, the Riemannian Center of Mass from the [Get started: optimize](getstarted.md) tutorial.
...
We further need three internal functions from `Manopt.jl`
