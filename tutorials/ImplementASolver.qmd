...
when to stop, consider implementing your own [stopping criterion](../plans/stopping_criteria.md) instead.
...
for example [`debug=` for debug](../commons/debugs.md), [`record=`](../plans/record.md) keywords for debug and recording
