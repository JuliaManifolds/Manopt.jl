...
introductory tutorial [🏔️ Get started with Manopt.jl](https://manoptjl.org/stable/tutorials/getstarted.html).
...
We first define our task, the Riemannian Center of Mass from the [🏔️ Get started with Manopt.jl](https://manoptjl.org/stable/tutorials/getstarted.html) tutorial.
