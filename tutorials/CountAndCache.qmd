...
[LRUCache.jl](https://github.com/JuliaCollections/LRUCache.jl) which is (since Julia 1.9) a weak dependency and provides
...
And while we again have a split of the cost and gradient evaluations, we can observe that the allocations are less than half of the previous approach.
