...
In order to recover $v_0$ we consider the constrained optimization problem on the sphere $\mathcal S^{d-1}$ given by

```math
\begin{align*}
\operatorname*{arg\,min}_{p∈\mathcal S^{d-1}} & -p^{\mathrm{T}}Zp\\
