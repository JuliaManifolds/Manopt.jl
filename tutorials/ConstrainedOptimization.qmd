...
This can be seen as a balance between moving constraints into the geometry of a manifold $\mathcal M$ and keeping some, since they can be handled well in algorithms, see [@BergmannHerzog:2019], [@LiuBoumal:2019] for details.
...
We will consider the problem of a Nonnegative PCA, cf. Section 5.1.2 in [@LiuBoumal:2019]:
