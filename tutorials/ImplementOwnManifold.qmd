...
For both, we here use the “lazy” approach of using the [Sphere]() as a fallback
...
We at least see, that the function value descreased.
...
But we for example automaticaly also get the possibility to obtain debug information like
