...
@test artificial_S1_slope_signal(20,0.) == repeat([-π/2],20)

@test ismissing( artificial_S1_signal(-1.) )
@test ismissing( artificial_S1_signal(2.) )
...
@test length( artificial_S2_lemniscate([0.,0.,1.], 20))  == 20
@test length( artificial_S2_lemniscate([0.,0.,1.], 20)[1]) == 3
