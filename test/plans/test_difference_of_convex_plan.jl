...
@testset "Difference of Convex Plan" begin
    ...
    @testset "show/repr and status_summary" begin
        ...
        s2 = repr(dc_obj_ga)
        @test startswith(s2, "ManifoldDifferenceOfConvexObjective(")
        @test contains(s2, "gradient = ")
        ...
        s4 = repr(dcp_obja)
        @test startswith(s4, "ManifoldDifferenceOfConvexProximalObjective(")
        s5 = repr(dcp_obj_ga)
        @test startswith(s5, "ManifoldDifferenceOfConvexProximalObjective(")
        @test contains(s5, "gradient = ")
