...
A `SimpleManifoldCachedObjective`""",
        ...
        @test X == r
        @test sco1.objective.functions[2].i == 3
        ...
        @test sco4.objective.functions.i == 2
