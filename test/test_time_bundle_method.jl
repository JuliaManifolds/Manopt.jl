...
function plot_time_graphs(m::Int)
    ...
    p1 = plot([3:m], [t1 t2]; title = "Bundle Method", label = ["Hyperbolic Space" "Symmetric Pos Def Matirces"], xlabel = "Dimension", ylabel = "Time")
    p2 = plot([3:m], [s1 s2]; title = "Subgradient Method", label = ["Hyperbolic Space" "Symmetric Pos Def Matirces"], xlabel = "Dimension", ylabel = "Time")
    #display(plot(p1, p2))
    return nothing
end